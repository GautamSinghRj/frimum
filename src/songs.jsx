...
function Songs(){
    return(
        <div>
          ...
          <div className="p-10 flex flex-col xl:flex-row justify-center items-center gap-10 md:gap-20 xl:gap-28">
            {moods.map((mood) => (
              <div key={mood.id} >
          ...
          <div className="flex flex-row justify-center items-center gap-12 md:gap-16 xl:gap-20">
            {artists.map((artist) => (

...
const stripePromise = loadStripe(paykey); 
  ...
  const handlePayment = async () => {
    ...
    return (
        <header>
            <div className="h-0.02vh p-10 md:h-24 xl:h-24 flex flex-col md:flex-row xl:flex-row gap-8 md:gap-24 xl:gap-24 justify-center items-center
             no-underline text-base bg-slate-950 text-slate-950 font-semibold font-(font-family: 'Circular', 'Circular Std', 'Gotham', 'Montserrat', sans-serif)">
                <img className="xl:-translate-x-24 transform w-36 md:w-64 xl:w-64 h-20" src="./pic/logo.png" alt="Logo For Frimum Music Streaming" />

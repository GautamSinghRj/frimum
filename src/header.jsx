    ...
    return (
        <header>
           <div className="fixed top-0 left-0 z-40 w-full h-24 p-4 md:p-8 flex flex-col md:flex-row  gap-4 items-center justify-between bg-slate-950 text-white">
                ...
                <Link to="/" className="transform md:translate-x-10 xl:translate-x-60 2xl:translate-x-36 rounded-full" style={{ backgroundColor: '#1E1E1E'}}>
                ...
                <Link to="/srcsong" className="z-50 translate-y-6 md:translate-y-0 xl:translate-y-0 -translate-x-32 md:translate-x-20 transform xl:translate-x-20 2xl:translate-x-6">
                <img
                    loading="lazy"
                ...
                <Link to="/auth">
                 <img
                    loading="lazy"
                    className="transform -translate-y-8 xl:-translate-y-0 xl:-translate-x-80 2xl:-transalte-x-64 ml-2 w-12 h-12 hover:scale-110 transform transition-all duration-200 ease-in-out"
                    src="./pic/user.png"
